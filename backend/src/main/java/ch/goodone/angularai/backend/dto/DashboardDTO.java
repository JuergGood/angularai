...
public class DashboardDTO {
    ...
    public List<TaskDTO> getPriorityTasks() {
        return priorityTasks;
    }

    public void setPriorityTasks(List<TaskDTO> priorityTasks) {
        this.priorityTasks = priorityTasks;
    }

    public List<ActionLogDTO> getRecentActivity() {
        return recentActivity;
    }

    public void setRecentActivity(List<ActionLogDTO> recentActivity) {
        this.recentActivity = recentActivity;
    }
    ...
    public TaskStatusDistribution getTaskDistribution() {
        return taskDistribution;
    }

    public void setTaskDistribution(TaskStatusDistribution taskDistribution) {
        this.taskDistribution = taskDistribution;
    }
    ...
    public static class SummaryStats {
        ...
        public long getOpenTasksDelta() {
            return openTasksDelta;
        }

        public void setOpenTasksDelta(long openTasksDelta) {
            this.openTasksDelta = openTasksDelta;
        }
        ...
        public long getActiveUsersDelta() {
            return activeUsersDelta;
        }

        public void setActiveUsersDelta(long activeUsersDelta) {
            this.activeUsersDelta = activeUsersDelta;
        }
        ...
        public long getCompletedTasksDelta() {
            return completedTasksDelta;
        }

        public void setCompletedTasksDelta(long completedTasksDelta) {
            this.completedTasksDelta = completedTasksDelta;
        }
        ...
        public long getTodayLogsDelta() {
            return todayLogsDelta;
        }

        public void setTodayLogsDelta(long todayLogsDelta) {
            this.todayLogsDelta = todayLogsDelta;
        }
    }
