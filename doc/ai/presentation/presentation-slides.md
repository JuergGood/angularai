...
:::
::: column
![**Resultat**](files/images/DashboardImplementation.png)
...
- Alles begann mit diesen Objectives
...
- Initial Plan, generated by AI
  - Initialize Spring Boot project in `backend` folder.
  - Initialize Angular project in `frontend` folder.
  - Define User entity and repository in Backend.
  - Implement Backend REST API for User administration (CRUD + Login).
  - Implement Frontend services for API interaction.
  - Create Login page in Frontend.
  - Create User Profile Editing page in Frontend.
...
# Prompting-Beispiele
- Implementiere ... 
  - Frontend und Backend mit initalen Anforderungen
...
::: columns
::: column
![](files/images/DashboardBefore.png)
Vorher

:::
::: column
![](files/images/DashboardProposal.png)
Design Vorschlag
