...
class LoadCommand : Command {
    ...
    override fun execute(client: ApiClient, args: List<String>) {
        if (args.isEmpty()) {
            println("Usage: load [tasks|users|logs|paging-data|custom]")
            return
        }
        ...
        when (args[0]) {
            ...
            "logs" -> println("ActionLog entries are generated by actions. Try 'load tasks' to see logs.")
            "paging-data" -> loadPagingData(client, args.drop(1))
